...
public class Main {
    public static void main(String[] args) {
        ...
        StreamOperations.getDepartments(students);
        System.out.println();
        StreamOperations.getStudentsEnrolledAfter2018(students);
        System.out.println();
        StreamOperations.getMaleDetailsInCSE(students);
        System.out.println();
        StreamOperations.getMaleAndFemaleCount(students);
        System.out.println();
        StreamOperations.getAverage(students);
        System.out.println();
        StreamOperations.getStudentWithHighestPercentage(students);
        System.out.println();
        StreamOperations.getStudentsInEachDepartment(students);
        System.out.println();
        StreamOperations.getAveragePercentageInEachDepartment(students);
        System.out.println();
        StreamOperations.getDetailsOfYoungestMaleInElectronic(students);
        System.out.println();
        StreamOperations.getMaleAndFemaleCountInCSE(students);
    }
}